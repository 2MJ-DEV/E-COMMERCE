-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('LEGUME', 'VIANDE');

-- CreateEnum
CREATE TYPE "ProductUnit" AS ENUM ('KG', 'PIECE', 'BOTTE');
...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('CASH', 'CARD', 'MOBILE_MONEY');
